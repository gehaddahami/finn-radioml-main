...
################################################################
# This is a generated script based on design: radioml_demo
#
...
# source radioml_demo_script.tcl
...
xilinx_finn:finn:StreamingDataflowPartition_1:1.0\
xilinx.com:hls:StreamingDataflowPartition_2_IODMA_0:1.0\
User_Company:SysGen:finnadapter:1.0\
xilinx.com:ip:xlconstant:1.1\
xilinx.com:ip:proc_sys_reset:5.0\
User_Company:SysGen:receiver:1.0\
xilinx.com:ip:axis_broadcaster:1.1\
User_Company:SysGen:transmitter:1.0\
xilinx.com:ip:usp_rf_data_converter:2.6\
xilinx.com:ip:xlconcat:2.1\
xilinx.com:ip:zynq_ultra_ps_e:3.4\
User_Company:SysGen:inspector:1.0\
"
...
proc create_hier_cell_DataInspector { parentCell nameHier } {
  ...
  set data_inspector_module [ create_bd_cell -type ip -vlnv User_Company:SysGen:inspector:1.0 data_inspector_module ]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: finn_accelerator, and set properties
  set finn_accelerator [ create_bd_cell -type ip -vlnv xilinx_finn:finn:StreamingDataflowPartition_1:1.0 finn_accelerator ]

  # Create instance: finn_odma, and set properties
  set finn_odma [ create_bd_cell -type ip -vlnv xilinx.com:hls:StreamingDataflowPartition_2_IODMA_0:1.0 finn_odma ]

  # Create instance: finnadapter, and set properties
  set finnadapter [ create_bd_cell -type ip -vlnv User_Company:SysGen:finnadapter:1.0 finnadapter ]
  ...
  set receiver [ create_bd_cell -type ip -vlnv User_Company:SysGen:receiver:1.0 receiver ]
  ...
  # Create instance: rx_broadcaster_im, and set properties
  set rx_broadcaster_im [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 rx_broadcaster_im ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
   CONFIG.HAS_TREADY {1} \
  ...
  # Create instance: rx_broadcaster_re, and set properties
  set rx_broadcaster_re [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 rx_broadcaster_re ]
  set_property -dict [ list \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
   CONFIG.HAS_TREADY {1} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net DataInspector_M_AXI [get_bd_intf_pins DataInspector/M_AXI] [get_bd_intf_pins axi_mem_intercon_1/S01_AXI]
  ...
  connect_bd_intf_net -intf_net finn_accelerator_m_axis_0 [get_bd_intf_pins finn_accelerator/m_axis_0] [get_bd_intf_pins finn_odma/in0_V_V]
  connect_bd_intf_net -intf_net finn_odma_m_axi_gmem [get_bd_intf_pins axi_mem_intercon_1/S02_AXI] [get_bd_intf_pins finn_odma/m_axi_gmem]
  connect_bd_intf_net -intf_net finnadapter_m_axis [get_bd_intf_pins finn_accelerator/s_axis_0] [get_bd_intf_pins finnadapter/m_axis]
  ...
  connect_bd_intf_net -intf_net ps8_axi_periph_M07_AXI [get_bd_intf_pins finn_odma/s_axi_control] [get_bd_intf_pins ps8_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps8_axi_periph_M08_AXI [get_bd_intf_pins finnadapter/finnadapter_s_axi] [get_bd_intf_pins ps8_axi_periph/M08_AXI]
  ...
  connect_bd_intf_net -intf_net rx_broadcaster_im_M00_AXIS [get_bd_intf_pins receiver/s_axis_im] [get_bd_intf_pins rx_broadcaster_im/M00_AXIS]
  connect_bd_intf_net -intf_net rx_broadcaster_im_M01_AXIS [get_bd_intf_pins finnadapter/s_axis_im] [get_bd_intf_pins rx_broadcaster_im/M01_AXIS]
  connect_bd_intf_net -intf_net rx_broadcaster_re_M00_AXIS [get_bd_intf_pins receiver/s_axis_re] [get_bd_intf_pins rx_broadcaster_re/M00_AXIS]
  connect_bd_intf_net -intf_net rx_broadcaster_re_M01_AXIS [get_bd_intf_pins finnadapter/s_axis_re] [get_bd_intf_pins rx_broadcaster_re/M01_AXIS]
  connect_bd_intf_net -intf_net sysref_in_1 [get_bd_intf_ports sysref_in] [get_bd_intf_pins usp_rf_data_converter/sysref_in]
  connect_bd_intf_net -intf_net transmitter_m_axis [get_bd_intf_pins transmitter/m_axis] [get_bd_intf_pins usp_rf_data_converter/s10_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_m20_axis [get_bd_intf_pins rx_broadcaster_re/S_AXIS] [get_bd_intf_pins usp_rf_data_converter/m20_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_m21_axis [get_bd_intf_pins rx_broadcaster_im/S_AXIS] [get_bd_intf_pins usp_rf_data_converter/m21_axis]
  ...
  connect_bd_net -net finn_odma_interrupt [get_bd_pins finn_odma/interrupt] [get_bd_pins xlconcat/In5]
  connect_bd_net -net lmk_reset_low_dout [get_bd_ports lmk_reset] [get_bd_pins lmk_reset_low/dout]
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins DataInspector/aresetn] [get_bd_pins axi_dma_rx/axi_resetn] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/S01_ARESETN] [get_bd_pins axi_mem_intercon_1/S02_ARESETN] [get_bd_pins finn_accelerator/ap_rst_n] [get_bd_pins finn_odma/ap_rst_n] [get_bd_pins finnadapter/finnadapter_aresetn] [get_bd_pins proc_sys_reset_adc0/peripheral_aresetn] [get_bd_pins ps8_axi_periph/M04_ARESETN] [get_bd_pins ps8_axi_periph/M05_ARESETN] [get_bd_pins ps8_axi_periph/M06_ARESETN] [get_bd_pins ps8_axi_periph/M07_ARESETN] [get_bd_pins ps8_axi_periph/M08_ARESETN] [get_bd_pins receiver/receiver_aresetn] [get_bd_pins rx_broadcaster_im/aresetn] [get_bd_pins rx_broadcaster_re/aresetn] [get_bd_pins usp_rf_data_converter/m2_axis_aresetn]
  connect_bd_net -net proc_sys_reset_dac1_peripheral_aresetn [get_bd_pins axi_dma_tx/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins proc_sys_reset_dac1/peripheral_aresetn] [get_bd_pins ps8_axi_periph/M01_ARESETN] [get_bd_pins ps8_axi_periph/M02_ARESETN] [get_bd_pins transmitter/transmitter_aresetn] [get_bd_pins usp_rf_data_converter/s1_axis_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_clk_adc0 [get_bd_pins DataInspector/aclk] [get_bd_pins axi_dma_rx/m_axi_s2mm_aclk] [get_bd_pins axi_dma_rx/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_1/S01_ACLK] [get_bd_pins axi_mem_intercon_1/S02_ACLK] [get_bd_pins finn_accelerator/ap_clk] [get_bd_pins finn_odma/ap_clk] [get_bd_pins finnadapter/clk] [get_bd_pins proc_sys_reset_adc0/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M04_ACLK] [get_bd_pins ps8_axi_periph/M05_ACLK] [get_bd_pins ps8_axi_periph/M06_ACLK] [get_bd_pins ps8_axi_periph/M07_ACLK] [get_bd_pins ps8_axi_periph/M08_ACLK] [get_bd_pins receiver/clk] [get_bd_pins rx_broadcaster_im/aclk] [get_bd_pins rx_broadcaster_re/aclk] [get_bd_pins usp_rf_data_converter/clk_adc2] [get_bd_pins usp_rf_data_converter/m2_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp2_fpd_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac1 [get_bd_pins axi_dma_tx/m_axi_mm2s_aclk] [get_bd_pins axi_dma_tx/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins proc_sys_reset_dac1/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M01_ACLK] [get_bd_pins ps8_axi_periph/M02_ACLK] [get_bd_pins transmitter/clk] [get_bd_pins usp_rf_data_converter/clk_dac1] [get_bd_pins usp_rf_data_converter/s1_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces finn_odma/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces finn_odma/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces finn_odma/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_QSPI] -force
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs finn_odma/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0040000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs finnadapter/finnadapter_s_axi/reg0] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces finn_odma/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM]
