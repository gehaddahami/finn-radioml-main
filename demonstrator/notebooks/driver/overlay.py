...
class RadioMLOverlay(Overlay):
    ...
    def __init__(self, bitfile_name=None, init_rf_clks=True, **kwargs):
        ...
        self.receiver = Receiver(self.axi_dma_rx, self.receiver, self.DataInspector) # The receiver is coupled with an inspector
        self.transmitter = Transmitter(self.axi_dma_tx, self.transmitter)
