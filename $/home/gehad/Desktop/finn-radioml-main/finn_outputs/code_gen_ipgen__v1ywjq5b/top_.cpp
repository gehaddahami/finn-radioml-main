...
Matrix_Vector_Activate_Stream_Batch<MW1, MH1, SIMD1, PE1, Slice<ap_uint<2>>, Slice<ap_int<15>>, Identity, ap_int<8> >
                (in0_V, out_V, weights_V, PassThroughActivation<ap_int<15>>(), numReps, ap_resource_dflt());
}
